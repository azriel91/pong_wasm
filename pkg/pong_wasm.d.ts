...
export class PongAppBuilder {
  free(): void;
/**
* Returns a new `PongAppBuilder`.
* @returns {PongAppBuilder} 
*/
  static new(): PongAppBuilder;
/**
* Sets the canvas element for the `PongAppBuilder`.
* @param {HTMLCanvasElement} canvas 
* @returns {PongAppBuilder} 
*/
  with_canvas(canvas: HTMLCanvasElement): PongAppBuilder;
/**
* Sets the canvas element for the `PongAppBuilder`.
* @param {string} input_bindings_str 
* @returns {PongAppBuilder} 
*/
  with_input_bindings(input_bindings_str: string): PongAppBuilder;
/**
*/
  run(): void;
}
...
export interface InitOutput {
  readonly __wbg_pongappbuilder_free: (a: number) => void;
  readonly pongappbuilder_new: () => number;
  readonly pongappbuilder_with_canvas: (a: number, b: number) => number;
  readonly pongappbuilder_with_input_bindings: (a: number, b: number, c: number) => number;
  readonly pongappbuilder_run: (a: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1ddfaf359b470f6f: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2ffac9bcd126678c: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha09c3a1ed47f0176: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2a90882db614999f: (a: number, b: number, c: number) => void;
