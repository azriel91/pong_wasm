/* tslint:disable */
/* eslint-disable */
export function __wbg_pongappbuilder_free(a: number): void;
export function pongappbuilder_new(): number;
export function pongappbuilder_with_canvas(a: number, b: number): number;
export function pongappbuilder_with_input_bindings(a: number, b: number, c: number): number;
export function pongappbuilder_run(a: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1ddfaf359b470f6f(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2ffac9bcd126678c(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha09c3a1ed47f0176(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2a90882db614999f(a: number, b: number, c: number): void;
